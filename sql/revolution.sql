...
DROP SCHEMA IF EXISTS `revolution` ;
CREATE SCHEMA IF NOT EXISTS `revolution` DEFAULT CHARACTER SET utf8 COLLATE utf8_general_ci ;
USE `revolution` ;

-- -----------------------------------------------------
-- Table `revolution`.`areas`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `revolution`.`areas` ;

CREATE  TABLE IF NOT EXISTS `revolution`.`areas` (
  `area_id` INT(11) NOT NULL AUTO_INCREMENT ,
  `area_name` VARCHAR(255) CHARACTER SET 'utf8' COLLATE 'utf8_bin' NOT NULL ,
...
-- -----------------------------------------------------
-- Table `revolution`.`commons`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `revolution`.`commons` ;

CREATE  TABLE IF NOT EXISTS `revolution`.`commons` (
  `common_id` INT(11) NOT NULL AUTO_INCREMENT ,
  `common_id_name` VARCHAR(255) CHARACTER SET 'utf8' COLLATE 'utf8_bin' NOT NULL ,
  `common_content` TEXT CHARACTER SET 'utf8' COLLATE 'utf8_bin' NOT NULL ,
...
-- -----------------------------------------------------
-- Table `revolution`.`countries`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `revolution`.`countries` ;

CREATE  TABLE IF NOT EXISTS `revolution`.`countries` (
  `country_id` INT(11) NOT NULL AUTO_INCREMENT ,
  `country_iso` VARCHAR(255) CHARACTER SET 'utf8' COLLATE 'utf8_bin' NOT NULL ,
  `country_name` VARCHAR(80) CHARACTER SET 'utf8' COLLATE 'utf8_bin' NOT NULL ,
  `country_nicename` VARCHAR(80) CHARACTER SET 'utf8' COLLATE 'utf8_bin' NOT NULL ,
  `country_iso3` CHAR(3) CHARACTER SET 'utf8' COLLATE 'utf8_bin' NOT NULL ,
...
-- -----------------------------------------------------
-- Table `revolution`.`events`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `revolution`.`events` ;

CREATE  TABLE IF NOT EXISTS `revolution`.`events` (
  `event_id` INT(11) NOT NULL AUTO_INCREMENT ,
  `event_title` TEXT CHARACTER SET 'utf8' COLLATE 'utf8_bin' NOT NULL ,
  `event_author` VARCHAR(255) CHARACTER SET 'utf8' COLLATE 'utf8_bin' NOT NULL ,
  `event_date_published` DATETIME NOT NULL ,
  `event_link` TEXT CHARACTER SET 'utf8' COLLATE 'utf8_bin' NOT NULL ,
  `event_content` TEXT CHARACTER SET 'utf8' COLLATE 'utf8_bin' NOT NULL ,
...
-- -----------------------------------------------------
-- Table `revolution`.`event_types`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `revolution`.`event_types` ;

CREATE  TABLE IF NOT EXISTS `revolution`.`event_types` (
  `event_type_id` INT(11) NOT NULL AUTO_INCREMENT ,
  `event_type_name` VARCHAR(255) CHARACTER SET 'utf8' COLLATE 'utf8_bin' NOT NULL ,
...
-- -----------------------------------------------------
-- Table `revolution`.`history`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `revolution`.`history` ;

CREATE  TABLE IF NOT EXISTS `revolution`.`history` (
  `entry_id` INT(11) NOT NULL AUTO_INCREMENT ,
  `entry_title` VARCHAR(255) CHARACTER SET 'utf8' COLLATE 'utf8_bin' NOT NULL ,
  `entry_lead` TEXT CHARACTER SET 'utf8' COLLATE 'utf8_bin' NOT NULL ,
  `entry_content` TEXT CHARACTER SET 'utf8' COLLATE 'utf8_bin' NOT NULL ,
  `entry_year_start` INT(11) NOT NULL ,
  `entry_year_end` INT(11) NOT NULL ,
  `entry_url` TEXT CHARACTER SET 'utf8' COLLATE 'utf8_bin' NOT NULL ,
  `entry_date_published` DATETIME NOT NULL ,
  `entry_date_updated` DATETIME NOT NULL ,
...
-- -----------------------------------------------------
-- Table `revolution`.`regions`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `revolution`.`regions` ;

CREATE  TABLE IF NOT EXISTS `revolution`.`regions` (
  `region_id` INT(11) NOT NULL AUTO_INCREMENT ,
  `region_name` VARCHAR(255) CHARACTER SET 'utf8' COLLATE 'utf8_bin' NOT NULL ,
  PRIMARY KEY (`region_id`) ,
  UNIQUE INDEX `region_name` (`region_name` ASC) )
ENGINE = InnoDB
AUTO_INCREMENT = 1
DEFAULT CHARACTER SET = utf8
COLLATE = utf8_bin;
...
-- -----------------------------------------------------
-- Table `revolution`.`rss`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `revolution`.`rss` ;

CREATE  TABLE IF NOT EXISTS `revolution`.`rss` (
...
INSERT INTO `revolution`.`areas` (`area_id`, `area_name`, `area_x`, `area_y`) VALUES
(20, 'Peru', 265, 300),
(21, 'Ecuador', 250, 280),
(22, 'Colombia', 265, 265),
(23, 'Cuba', 265, 215),
...
INSERT INTO `revolution`.`history` (`entry_id`, `entry_title`, `entry_lead`, `entry_content`, `entry_year_start`, `entry_year_end`, `entry_url`, `entry_date_published`, `entry_date_updated`) VALUES
...
INSERT INTO `revolution`.`countries` (`country_id`, `country_iso`, `country_name`, `country_nicename`, `country_iso3`, `country_numcode`, `country_phonecode`) VALUES
...
INSERT INTO `revolution`.`events` (`event_id`, `event_title`, `event_author`, `event_date_published`, `event_link`, `event_content`, `area_id`, `event_type_id`) VALUES
...
INSERT INTO `revolution`.`event_types` (`event_type_id`, `event_type_name`) VALUES
(1, 'Revolution'),
(2, 'Uprising'),
(3, 'Protest');
